...
import com.cinqc.maraichage.service.ProducerOriginService;



@RestController
@CrossOrigin
@RequestMapping("/producerOrigins")
public class ProducerOriginController {

	@Autowired
	ProducerOriginService service;
	
	@GetMapping
	@ResponseStatus(HttpStatus.OK)
	public Iterable<ProducerOriginDTO> findAllProducerOrigins() {
		return service.findAllProducerOrigins();
	}
